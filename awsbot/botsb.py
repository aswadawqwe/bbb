...
def helpmessage():
    helpMessage = "╔═══════════════" + "\n" + \
                  ...
                  "╠✪〘 Media 〙✪════════" + "\n" + \
                  "╠➥ Kalender" + "\n" + \
                  "╠➥ CheckCuaca (Maintance)" + "\n" + \
                  "╠➥ JadwalShalat (Maintance)" + "\n" + \
                  "╠➥ InstagramInfo「Username tanpa @」 (Maintance)" + "\n" + \
                  "╠➥ InstagramPost「UserName tanpa @」 (Maintance)" + "\n" + \
                  "╠➥ SearchYoutube「Metallica」" + "\n" + \
                  "╠➥ SearchImage「Keyword」 (Maintance)" + "\n" + \
                  "╠➥ ScreenshotWebsite 「URL」 (Maintance)" + "\n" + \
                  "║" + "\n" + \
                  "╚═〘 Owner : Wendy Amarul  〙"
    return helpMessage
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    nadya.sendMessage(to, "Contact Owner")
...
#==============================================================================#
                    ...
                    if msg.toType == 2:
                        ...
                        if group.preventedJoinByTicket == False:
                            ...
                            nadya.sendMessage(to, "Grup qr tidak terbuka silahkan buka terlebih dahulu dengan perintah {} groupticket".format(str(settings["keyCommand"])))
...
#==============================================================================#
                    ...
                    if msg.to in read['readPoint']:
                            ...
                            with open('read.json', 'w') as fp:
                                ...
                                nadya.sendMessage(msg.to,"set read already on")
                    else:
                        try:
                            del read['readPoint'][msg.to]
                            del read['readMember'][msg.to]
                    ...
                    if msg.to not in read['readPoint']:
                        nadya.sendMessage(msg.to,"set read already off")
                    else:
                        try:
                            del read['readPoint'][msg.to]
                            del read['readMember'][msg.to]
                    ...
                    if msg.to in read["readPoint"]:
                        ...
                        nadya.sendMessage(msg.to, "setread belum diaktifkan ngapain di reset?")
